...
`A3 BILAN : TOUS LES TESTS ONT REUSSI (119/119, 0 IGNORE)`. L'en-tête du script
...
| 26/09/2026 | `ia_statistiques_serveur.sql` | Analyse IA : `ai_statistics_rows()` fournit à `ai-proxy` les lignes anonymes des statistiques, `ai_question_mentions_person()` repère le prénom et le nom d'une personne dans une question ; exécutables avec la clé de service seulement | Oui | — |

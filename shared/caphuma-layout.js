...
function renderDashboardLayout() {
    ...
    header.innerHTML = `
        <div class="container mx-auto px-6 py-4 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4">
            <div class="flex items-center gap-3">
            ...
            <nav class="flex items-center gap-2 flex-wrap justify-end">
                ...
                <span id="adminNavGroup" class="hidden flex-wrap sm:flex-nowrap items-center gap-2">
